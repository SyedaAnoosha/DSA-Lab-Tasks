...
public class HashTable {
    ...
    void dump() {
       ...
       This method is NOT part of the usual interface for a hash table.  It is here only to be used for testing
       purposes, and should be removed before the class is released for general use.  This lists the (key,value)
       pairs in each location of the table.
       // dump is basically display
    ...
    public Object get(Object key) {
        ...
        while (list != null) {
            ...
            // Check if the specified key is in the node that list points to.  If so, return the associated value.
            if (list.key.equals(key))
                return list.value;
        ...
        // Return the value null to indicate that the key is not in the table.
    ...
    public void remove(Object key) {
        ...
        // Remove the key and its associated value from the table, if the key occurs in the table.  If it does not occur,
        ...
        // We have to remove a node from somewhere in the middle of the list, or at the end.  Use a pointer to traverse
        // the list, looking for a node that contains the specified key, and remove it if it is found.

        ListNode prev = table[bucket];  // The node that precedes

        // curr in the list.  Prev.next is always equal to curr.
        ...
        /*
         If we get to this point, then either curr is null, or curr.key is equal to key.  In the later case,
         we have to remove curr from the list.  Do this by making prev.next point to the node after curr,
         instead of to curr.  If curr is null, it means that the key was not found in the table, so there is nothing to do.
         */
    ...
    private int hash(Object key) {
        ...
        // Compute a hash code for the key; key cannot be null. The hash code depends on the size of the table as
    ...
    private void resize() {
        ...
        for (int i = 0; i < table.length; i++) {
            ...
            while (list != null) {
                ...
                // hash is the hash code of list.key that is appropriate for the new table size. The two lines add the node pointed to by
                // list onto the head of the linked list in the new table at position number hash.
